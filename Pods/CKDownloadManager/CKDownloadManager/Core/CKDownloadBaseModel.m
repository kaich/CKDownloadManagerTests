...
-(id) init
{
    ...
    self.completeState = @"3";
    self.downloadTime=[NSString stringWithFormat:@"%f",MAXFLOAT];
...
{
    NSMutableDictionary * dic=[NSMutableDictionary dictionaryWithObjectsAndKeys:@"title",DWONLOAD_ITME_NAME,@"URLString",URL_LINK_STRING,@"downloadFinalPath",FINAL_PATH_STRING,@"totalCotentSize",TOTAL_CONTENT_SIZE,@"completeState",IS_DOWNLOAD_COMPLETE,@"downloadContentSize",DOWNLOAD_CONTENT_SIZE,@"imgURLString",ICON_IMAGE_URL,@"restTime",DOWNLOAD_REST_TIME,@"dependenciesString",DOWNLOAD_DEPENDENCY,@"downloadTime",APP_DOWNLOAD_TIME,@"referenceURL",DOWNLOAD_REFERENCE,nil];
